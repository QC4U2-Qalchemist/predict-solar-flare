...
# モデルのトレーニング
history = model.fit(X_train, y_train, epochs=300, batch_size=10, validation_split=0.1, callbacks=[tss_callback, checkpoint])
...
print("Final True Skill Statistic (TSS):", TSS)
